...
var userNumber = +prompt("Please Enter Any Number");
...
for (var numindex = 0; numindex < 5; numindex++) {
    var userSum = +prompt("Please Enter Five Number!");
    numbers.push(userSum)
    sum = sum + numbers;
    
}
console.log(`${sum}`);
for (var i = 0 varindex < array.lengtvarindex++) {
    const element = arrvarindex];
